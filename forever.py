...
def referer_list():
	...
	headers_referers.append('http://www.flickr.com/search/?q=')
	headers_referers.append('http://www.stopforumspam.com/search?q=')
	headers_referers.append('http://www.stopforumspam.com/search?q=')
        headers_referers.append('http://www.ted.com/search?q=')
        headers_referers.append('http://br.pinterest.com/search/?q=')
        headers_referers.append('http://www.iconfinder.com/search/?q=')                        
...
def helptext ():
        ...
        print " EX. python forever.py www.website.com -t 1000 -c 1000 -p 80"
        print ""
        ...
        print ""
        print " Script Feita por Ecosistema"
        print ""
        print "Contact for any BUGS or GLITCHES on Twitter @misa_zn / skype: saulo.zaquetti"
        exit()
